...
export default async function SimulatorPage() {
  ...
  const settings: FleetSettings = settingsRes.data
    ? {
        we_rate:        settingsRes.data.we_rate,
        total_fix:      settingsRes.data.total_fix,
        variable_costs: settingsRes.data.variable_costs,
      }
    : { we_rate: 0.27, total_fix: 0, variable_costs: 0 }

  return <SimulatorClient machines={machines} settings={settings} />
}
